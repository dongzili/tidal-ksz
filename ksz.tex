...
\title{Cross Correlate Tidal Reconstructed 21cm Signal with Kinematic Sunyaev-Zel'dovich Effect: A New Probe for Missing Baryons at $z\sim1}
%\input author.tex
\input abstract.tex
\pacs{}
\maketitle
...
\input when.tex
\section{Statistical Error in Real Surveys}
\input error.tex
\section{Conclusion and Future Application}
\section{Acknowledge}
